...
func (p *RGB565) RGB565At(x, y int) ColorRGB565 {
...
func (p *RGB565) SetRGB565(x, y int, c ColorRGB565) {
	if !(image.Point{x, y}.In(p.Rect)) {
		return
	}
	i := p.PixOffset(x, y)
...
func (p *RGB565) SubImage(r image.Rectangle) image.Image {
